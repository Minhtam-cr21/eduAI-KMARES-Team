-- =============================================================================
-- Khắc phục đệ quy RLS trên profiles + policy đầy đủ (user / admin / insert).
-- Chạy trong Supabase SQL Editor — tương đương migration 013_profiles_rls_consolidated.sql
-- =============================================================================
-- (Tuỳ chọn) SELECT * FROM pg_policies WHERE tablename = 'profiles';
-- =============================================================================
